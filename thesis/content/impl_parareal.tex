...
\begin{table}[p]
  ...
  \begin{tabular}{%
    ...
    S[table-format=3.2]
    S[table-format=3.2]
    S[table-format=-1.1e-1, round-precision=1, scientific-notation=engineering]
  }
    \toprule
    {warm-up} &
    {$N$} &
...
For the remainder of the thesis, we will always warm-up $G$ and $G$ only.
