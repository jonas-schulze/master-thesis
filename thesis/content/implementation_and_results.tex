...
\todo{%
  Remove usage of $\LandauO$; remove estimate on $r$.
  Instead: based on \autoref{fig:results:parareal:timeline},
  the number of compressions is more likely the cause that \ac{LRSIF}~2/2 fans out at about $n\geq 120$.
}
