...
\todo[inline]{%
  The construction of \cite{Li2002,Benner2009} results in a somewhat \enquote{diagonal} subsequence of ADI iterates:
  $x^k$ depends on $\Set{\alpha_{K-k+1},\ldots,\alpha_K}$.
}
