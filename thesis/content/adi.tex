...
\todo[inline]{%
Double-step for complex $\alpha_k\in\C\setminus\R$, $\alpha_{k+1} = \conj{\alpha_k}$, to maintain real arithmetic.
Where did this idea appear first?
}
...
\todo[inline]{Apply double-step presented in previous section.}
