...
\begin{algorithm}[t]
  ...
  $Q \gets \orth G$\;
  $ \Set{\alpha_1, \alpha_2, \ldots} \gets \Lambda(Q^\HT A Q, Q^\HT E Q) \cap \Cneg$\;
  ...
  %TODO: ...or $j > J$
    \If{$\alpha_k$ is not available}{%
      ...
      $\Set{\alpha_k, \alpha_{k+1}, \ldots} \gets \Lambda(Q^\HT A Q, Q^\HT E Q) \cap \Cneg$\;
    }
